...
public class Main {
    public static void main(String[] args) throws UniversityHasNoFacultiesException, MarkIsOutOfBoundException, FacultyHasNoGroupsException, GroupHasNoStudentsException, StudentHasNoSubjectsException {
        ...
        students1.put("Brown", new Student.StudentBuilder().withStudentName("An").withStudentSurname("Gren").withSubjectAndItsMark("HISTORY", 7).withSubjectAndItsMark("LITERATURE", 8).build());
        ...
        students2.put("Rise", new Student.StudentBuilder().withStudentName("John").withStudentSurname("Rise").withSubjectAndItsMark("LITERATURE", 9).withSubjectAndItsMark("HISTORY", 10).build());
        ...
        students4.put("Got", new Student.StudentBuilder().withStudentName("All").withStudentSurname("Gott").withSubjectAndItsMark("PHYSICS", 8).withSubjectAndItsMark("ENGINERING", 10).build());
        ...
        HashMap<String, Faculty> listOfBNTUFaculties = new HashMap<>();
        ...
        universityBNTU.setFacultiesToUniversity(listOfBNTUFaculties);
